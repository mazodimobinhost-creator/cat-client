...
// 1. /sub basic
{
  ...
  check('remarks are Cat location labels with no IP', /#%F0%9F%90%B1%20Cat%20%C2%B7%20%F0%9F%8C%90%20Global%20%C2%B7%20VLESS%20%C2%B7%2080%20%C2%B7%20%23\d+/.test(body) && !decodeURIComponent(lines[0]).includes('104.16.'), lines[0]);
